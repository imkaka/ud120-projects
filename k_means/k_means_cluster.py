...
# maximum:  34348384.0  minimum:  3285.0 comment out line 81 to get rid of zeroes.
...
# mi = min(salary)
# print "Exercised stock options maximum: ", ma, " minimum: ", mi
# maximum:  1111258.0  minimum:  477.0 comment out line 941 to get rid of zeroes.
# print float(1000000 - mi) / (ma - mi)
...
for i in data_dict:
    if (data_dict[i]['from_messages'] == 'NaN'):
        ...
        fromm.append([float(data_dict[i]['from_messages'])])
print(fromm)
# scaler = MinMaxScaler()
# scaler.fit_transform(salary)
# print(scaler.transform([[200000.]]))
